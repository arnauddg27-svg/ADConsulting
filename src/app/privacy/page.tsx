        ...
        <Container>
          <div className="mx-auto max-w-4xl space-y-10 text-slate-300">
            <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6 md:p-8">
              ...
              <div className="mt-4 space-y-2 text-sm leading-6 text-slate-300">
                ...
                <p>
                  ...
                  {SITE_CONFIG.businessAddress || "To be added before Google Ads API resubmission"}
                </p>
              </div>
            </div>

            <div>
              <h2 className="font-heading text-2xl text-slate-50">Information Collected</h2>
              <p className="mt-4 leading-7 text-slate-400">
                AD ERP SYSTEMS may collect information you submit through
                website forms, Calendly booking flows, email, or discovery-call
                requests. This can include your name, company, business email,
                phone number, website, country, company type, current systems,
                and details about your reporting or data-platform needs.
              </p>
              <p className="mt-4 leading-7 text-slate-400">
                AD ERP SYSTEMS may also collect limited website usage data
                through analytics and advertising tools, including page views,
                traffic source, device/browser information, approximate location,
                and interactions with booking or contact links.
              </p>
            </div>

            <div>
              <h2 className="font-heading text-2xl text-slate-50">How Information Is Used</h2>
              <p className="mt-4 leading-7 text-slate-400">
            ...
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-400">
                AD ERP SYSTEMS does not sell personal information. Information
                may be shared with service providers that help operate the
                website, booking, analytics, advertising, CRM, email, or hosting
                systems, or when required to comply with legal obligations.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-400">
                AD ERP SYSTEMS retains information for as long as reasonably
                needed for the purposes described above, unless a longer
                retention period is required by law or business recordkeeping
                needs. Reasonable administrative and technical measures are used
                to protect information, but no website or internet transmission
            ...
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-400">
                You may contact AD ERP SYSTEMS to request an update or deletion
                of information you submitted, subject to legal, security, and
                business recordkeeping requirements. You can also control
