...
const compared = [
  { them: "Generic BI implementation", us: "Residential builder, developer + property management focus" },
  ...
  return (
    <BlueprintPage>
      <BlueprintHero
        ...
        title="Builder reporting built around residential operations + property management."
        description="We help residential builders, developers, and their property management arms turn scattered ERP, spreadsheet, finance, field, and property management data into daily operating views — and an AI data analyst on top — for schedule, budget, margin, lease, and owner follow-up. Delivered turnkey, fully client-owned."
      >
