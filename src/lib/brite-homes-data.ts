...
export const landDeals: SHLandDeal[] = [
  { id:1, name:"LAND-001", community:"Brite Ridge",    city:"Miami",        acres:30, lots:25, acquisitionCost:1200000, costPerLot:48000, status:"under-contract", closeDate:null },
  { id:2, name:"LAND-002", community:"Brite Coast",    city:"Jacksonville", acres:35, lots:30, acquisitionCost:1400000, costPerLot:46667, status:"under-contract", closeDate:null },
  { id:3, name:"LAND-003", community:"Brite Bay",      city:"Tampa",        acres:32, lots:28, acquisitionCost:1350000, costPerLot:48214, status:"under-contract", closeDate:null },
  { id:4, name:"LAND-004", community:"Brite Springs",  city:"Miami",        acres:25, lots:22, acquisitionCost:1100000, costPerLot:50000, status:"under-contract", closeDate:null },
  { id:5, name:"LAND-005", community:"Brite Park",     city:"Tampa",        acres:28, lots:26, acquisitionCost:1300000, costPerLot:50000, status:"under-contract", closeDate:null },
  { id:6, name:"LAND-006", community:"Brite Landing",  city:"Jacksonville", acres:27, lots:24, acquisitionCost:1250000, costPerLot:52083, status:"under-contract", closeDate:null },
];

/* ─── Permits ─── */
export const permits: SHPermit[] = [
  { id:1, jobCode:"BH-1001", community:"Brite Ridge",    city:"Miami",        permitType:"Building", submittedDate:"2025-06-15", approvedDate:"2025-06-20", daysInReview:5, status:"approved" },
  { id:2, jobCode:"BH-1002", community:"Brite Ridge",    city:"Miami",        permitType:"Building", submittedDate:"2025-08-25", approvedDate:"2025-09-01", daysInReview:7, status:"approved" },
  { id:3, jobCode:"BH-1003", community:"Brite Ridge",    city:"Miami",        permitType:"Electrical", submittedDate:"2025-11-10", approvedDate:null, daysInReview:136, status:"in-review" },
  { id:4, jobCode:"BH-1006", community:"Brite Ridge",    city:"Miami",        permitType:"Building", submittedDate:"2026-02-20", approvedDate:null, daysInReview:33, status:"in-review" },
  { id:5, jobCode:"BH-2001", community:"Brite Coast",    city:"Jacksonville", permitType:"Building", submittedDate:"2025-08-30", approvedDate:"2025-09-12", daysInReview:13, status:"approved" },
  { id:6, jobCode:"BH-2002", community:"Brite Coast",    city:"Jacksonville", permitType:"Plumbing", submittedDate:"2025-11-05", approvedDate:"2025-11-22", daysInReview:17, status:"approved" },
  { id:7, jobCode:"BH-2004", community:"Brite Coast",    city:"Jacksonville", permitType:"Building", submittedDate:"2026-01-15", approvedDate:null, daysInReview:69, status:"in-review" },
  { id:8, jobCode:"BH-3001", community:"Brite Bay",      city:"Tampa",        permitType:"Building", submittedDate:"2025-10-10", approvedDate:"2025-10-28", daysInReview:18, status:"approved" },
  { id:9, jobCode:"BH-3002", community:"Brite Bay",      city:"Tampa",        permitType:"Electrical", submittedDate:"2025-06-20", approvedDate:"2025-07-08", daysInReview:18, status:"approved" },
  { id:10, jobCode:"BH-3003", community:"Brite Bay",     city:"Tampa",        permitType:"Building", submittedDate:"2025-09-05", approvedDate:"2025-09-22", daysInReview:17, status:"approved" },
  { id:11, jobCode:"BH-4001", community:"Brite Springs", city:"Miami",        permitType:"Building", submittedDate:"2025-04-10", approvedDate:"2025-04-14", daysInReview:4, status:"approved" },
  { id:12, jobCode:"BH-4003", community:"Brite Springs", city:"Miami",        permitType:"Plumbing", submittedDate:"2025-09-05", approvedDate:null, daysInReview:202, status:"in-review" },
  { id:13, jobCode:"BH-5001", community:"Brite Park",    city:"Tampa",        permitType:"Building", submittedDate:"2025-03-10", approvedDate:"2025-03-14", daysInReview:4, status:"approved" },
  { id:14, jobCode:"BH-5005", community:"Brite Park",    city:"Tampa",        permitType:"Electrical", submittedDate:"2025-09-30", approvedDate:"2025-10-01", daysInReview:1, status:"approved" },
  { id:15, jobCode:"BH-6001", community:"Brite Landing", city:"Jacksonville", permitType:"Building", submittedDate:"2025-08-20", approvedDate:"2025-09-18", daysInReview:29, status:"approved" },
];

/* ─── Property Units ─── */
export const propertyUnits: SHPropertyUnit[] = [
  { id:1, address:"234 Brite Ridge Dr",    community:"Brite Ridge",    city:"Miami",        bedsBaths:"3/2.5", sqft:2100, monthlyRent:2800, marketRent:2950, occupancy:"leased",  tenant:"Johnson Family",     leaseEnd:"2027-05-01", delinquentAmount:0, daysPastDue:0 },
  { id:2, address:"456 Brite Vista Ave",   community:"Brite Ridge",    city:"Miami",        bedsBaths:"4/3", sqft:2400, monthlyRent:3200, marketRent:3400, occupancy:"leased",  tenant:"Davis Family",       leaseEnd:"2027-04-15", delinquentAmount:0, daysPastDue:0 },
  { id:3, address:"789 Brite Bay Dr",      community:"Brite Bay",      city:"Tampa",        bedsBaths:"3/2", sqft:1900, monthlyRent:2400, marketRent:2550, occupancy:"leased",  tenant:"Martinez Couple",    leaseEnd:"2027-05-01", delinquentAmount:150, daysPastDue:8 },
  { id:4, address:"321 Brite Park Ln",     community:"Brite Park",     city:"Tampa",        bedsBaths:"3/2.5", sqft:2100, monthlyRent:2700, marketRent:2850, occupancy:"leased",  tenant:"Thompson Family",    leaseEnd:"2027-04-01", delinquentAmount:0, daysPastDue:0 },
  { id:5, address:"654 Brite Coast Blvd",  community:"Brite Coast",    city:"Jacksonville", bedsBaths:"2/2", sqft:1700, monthlyRent:2200, marketRent:2350, occupancy:"vacant", tenant:null, leaseEnd:null, delinquentAmount:0, daysPastDue:0 },
  { id:6, address:"987 Brite Springs Pkwy", community:"Brite Springs",  city:"Miami",        bedsBaths:"4/3", sqft:2500, monthlyRent:3400, marketRent:3600, occupancy:"leased",  tenant:"Anderson Family",    leaseEnd:"2027-04-01", delinquentAmount:0, daysPastDue:0 },
  { id:7, address:"111 Brite Ridge Ct",    community:"Brite Ridge",    city:"Miami",        bedsBaths:"3/2", sqft:2000, monthlyRent:2600, marketRent:2750, occupancy:"leased",  tenant:"Wilson Family",      leaseEnd:"2027-07-01", delinquentAmount:0, daysPastDue:0 },
  { id:8, address:"222 Brite Bay Way",     community:"Brite Bay",      city:"Tampa",        bedsBaths:"2/2", sqft:1800, monthlyRent:2300, marketRent:2450, occupancy:"vacant", tenant:null, leaseEnd:null, delinquentAmount:0, daysPastDue:0 },
  { id:9, address:"333 Brite Springs Way", community:"Brite Springs",  city:"Miami",        bedsBaths:"4/3", sqft:2450, monthlyRent:3300, marketRent:3500, occupancy:"leased",  tenant:"Garcia Family",      leaseEnd:"2027-06-01", delinquentAmount:500, daysPastDue:30 },
  { id:10, address:"444 Brite Park Ave",   community:"Brite Park",    city:"Tampa",        bedsBaths:"3/2.5", sqft:2150, monthlyRent:2750, marketRent:2900, occupancy:"leased",  tenant:"Robinson Couple",    leaseEnd:"2027-05-15", delinquentAmount:0, daysPastDue:0 },
];
