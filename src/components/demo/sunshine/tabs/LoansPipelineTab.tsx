        ...
        <SHPanel kicker="Roster" title="Full Loan Roster">
          <SHSpreadsheetTable
            columns={[
              ...
              { key: "wipBalance", label: "WIP Balance", width: "85px", align: "right", render: r => fmt$(Number(r.wipBalance ?? 0)) },
              { key: "lender", label: "Lender", width: "160px" },
              { key: "loanType", label: "Loan Type", width: "95px", render: r => String(r.loanType ?? "\u2014") },
              ...
              { key: "salePrice", label: "Sale Price", width: "85px", align: "right", render: r => fmt$(Number(r.salePrice ?? 0)) },
              { key: "ltvPct", label: "LTV", width: "70px", align: "right", render: r => fmtPct(Number(r.ltvPct ?? 0)) },
              { key: "monthlyInterest", label: "Mo. Interest", width: "85px", align: "right", render: r => fmt$(Number(r.monthlyInterest ?? 0)) },
              { key: "accruedInterest", label: "Int. Accrued", width: "85px", align: "right", render: r => fmt$(Number(r.accruedInterest ?? 0)) },
              { key: "loanClosingDate", label: "Loan Close", width: "90px" },
              { key: "lastPaymentDate", label: "Last Payment", width: "90px" },
              { key: "drawRequests", label: "Draw Reqs", width: "70px", align: "right" },
              { key: "lenderContact", label: "Lender Contact", width: "140px" },
