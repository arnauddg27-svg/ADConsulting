...
import { getConstructionKPIs, getJobsByStage, getCommunityBreakdown, fmt$, fmtN, fmtPct } from "@/lib/brite-homes-data";
...
import SHSpreadsheetTable from "../../sunshine/SHSpreadsheetTable";
...
export default function BHConstructionDashboardTab({ jobs, onCommunityClick, onTabChange }: Props) {
