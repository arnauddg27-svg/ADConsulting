...
export default function BudgetVarianceChart({ filters }: BudgetVarianceChartProps) {
  ...
  return (
    <div className="rounded-xl border border-white/[0.06] bg-white/[0.025] p-5">
      ...
      <div className="relative mt-5 h-64">
        <div className={hasProjectFilter ? "opacity-40 transition-opacity duration-300" : "transition-opacity duration-300"}>
          {mounted ? (
        ...
        {hasProjectFilter && (
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            <span className="rounded-full border border-white/[0.06] bg-dark-950/80 px-3 py-1 text-xs text-slate-500">
