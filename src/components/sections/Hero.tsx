...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pb-12 pt-[10.5rem] md:pb-16 md:pt-[11rem]">
      ...
      <Container className="relative">
        <div className="animate-rise-in grid items-center gap-8 lg:grid-cols-[0.36fr_0.64fr] lg:gap-10">
          <div className="relative z-10 max-w-xl">
            <p className="text-[0.7rem] font-semibold uppercase tracking-[0.22em] text-accent-300">
              Builder data platform
            </p>
            <h1 className="mt-4 font-heading text-[2.75rem] leading-[0.94] tracking-[-0.04em] text-slate-50 sm:text-5xl lg:text-[4.25rem]">
            ...
            <div className="mt-8 grid grid-cols-3 gap-2 text-[0.58rem] uppercase tracking-[0.16em] text-slate-500">
              {["Sources", "Warehouse", "Dashboards"].map((item) => (
                <div
                  key={item}
