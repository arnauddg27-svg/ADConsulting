...
function GlassOperationsCard({
  ...
  return (
    <article className={cn("group h-full", className)}>
      <div className="relative h-full overflow-hidden rounded-[1.35rem] border border-[#d6e0e5] bg-white/[0.72] shadow-[0_30px_88px_-68px_rgba(23,33,44,0.58)] backdrop-blur-md transition duration-300 hover:-translate-y-1 hover:border-[#9eb6c8] hover:shadow-[0_38px_110px_-72px_rgba(23,33,44,0.68)]">
