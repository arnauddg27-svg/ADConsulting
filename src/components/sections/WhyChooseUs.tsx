...
const reasons = [
  ...
  {
    icon: <MapPin size={22} />,
    title: "Central Florida context",
    body: "Local knowledge of permitting, subcontractor coordination, seasonal pressure, and market realities.",
  },
];
      ...
      <Container>
        <div className="grid gap-10 lg:grid-cols-[0.4fr_0.6fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-5 max-w-lg font-heading text-4xl leading-[0.95] tracking-[0.04em] text-slate-50 md:text-5xl">
