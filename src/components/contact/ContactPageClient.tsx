            ...
            <div className="space-y-5">
              ...
              >
                ...
                <p className="mt-4 text-sm leading-7 text-slate-200">
                  After the initial call, we send a short worksheet covering your systems,
                  reporting gaps, data access, and priority dashboards. It gives us the
                  detail needed to prepare a practical scope and quote.
                </p>
              </Card>
            </div>
          </div>
