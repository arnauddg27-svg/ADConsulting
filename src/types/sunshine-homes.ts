...
export interface SHSale {
  ...
  netProceeds?: number;
  contractToCloseDays?: number | null;
...
export interface SHLoan {
  ...
  wipBalance?: number;
  lender: string;
  loanType?: "Construction" | "Acquisition" | "Bridge";
  loanAmount: number;
  totalDrawn: number;
  drawPct: number;
  interestRate: number;
...
export interface SHLandDeal {
  ...
  roiPct?: number;
  seller?: string;
  source?: "Direct" | "Broker" | "Assignment";
  dueDiligenceDays?: number;
  dueDiligenceStatus?: "Complete" | "In Progress" | "Pending";
  soilTesting?: "Pass" | "In Progress" | "Pending";
  surveyStatus?: "Complete" | "Scheduled" | "Pending";
  zoningStatus?: "Approved" | "In Review" | "Pending";
  platStatus?: "Recorded" | "Submitted" | "Pending";
  hasWetlands?: boolean;
  hasTreeClearing?: boolean;
  riskScore?: number;
...
export interface SHPermit {
  ...
  daysInReview: number;
  sitePlanCycleDays?: number;
  housePlanCycleDays?: number;
  septicCycleDays?: number;
  buildingDeptCycleDays?: number;
  jioApprovalCycleDays?: number;
  gopherTortoise?: boolean;
  treeSurvey?: boolean;
  floodZone?: "X" | "AE" | "VE";
  productType?: string;
